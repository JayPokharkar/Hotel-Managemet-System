...
<div>
  <h1>
    <center>
      <a href ="admin_add_rooms.php" class="link-dark">ADD ROOMS</a>
      <br>
    </center>
  </h1>
</div>
...
<div class="container">
  ...
  <table border="3" cellpadding="5" class="table-striped table-bordered table-hover" style="margin:auto" >
    ...
    <tbody>
      ...
      $view = mysqli_query($con, "select * from rooms");
      while ($row = mysqli_fetch_assoc($view)){
        ...
        <tr>
          ...
          <td><img src="images/<?php echo $row['room_image']; ?>" width="150" height="150" enctype="multipart/form-data"> </td>
          <td><?php echo $row["room_category"]; ?> </td>
          <td><?php echo $row["room_description"]; ?> </td>
          <td><center>
            <a href="admin_update_rooms.php?id=<?php echo $row["id"]; ?>">UPDATE</a></center>
          </td>
          <td><center>
            <a href="admin_delete_rooms.php?id=<?php echo $row["id"]; ?>">DELETE</a></center>
          </td>
        </tr>
        <?php
      }
